...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/marlin/level3/create_user.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="speciality" type="text" id="simpleinput" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="contact" type="text" id="simpleinput" class="form-control">
                                </div>
